...
class GitLabIssueService(private val client: GitLabApiClient) {
    ...
    fun searchMilestones(query: String, projectId: Int): List<co.anomaly.gitlab.models.GitLabMilestone> {
        val result = client.get(
            "/projects/$projectId/milestones",
            mapOf("search" to query, "per_page" to "100"),
            List::class.java
        )
        return result.filterIsInstance<co.anomaly.gitlab.models.GitLabMilestone>()
    }
